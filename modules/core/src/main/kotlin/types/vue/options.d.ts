...
// N.B. types.vue.external_declarations.vue.ComponentOptions<V> is contravariant, the default generic should be bottom type
...
/**
 * When the `Computed` type parameter on `types.vue.external_declarations.vue.ComponentOptions` is inferred,
 * it should have a property with the return type of every types.vue.external_declarations.vue.external_declarations.vue.external_declarations.vue.external_declarations.vue.get-accessor.
 * Since there isn't a way to query for the return type of a function, we allow TypeScript
 * to infer from the shape of `types.vue.external_declarations.vue.Accessors<Computed>` and work backwards.
 */
...
/**
 * This type should be used when an object mapped to `types.vue.external_declarations.vue.PropOptions` is used for a component's `props` value.
 */
